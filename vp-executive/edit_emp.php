		...
		<form method="post" class="form-horizontal">
						...
						<div class = "col-md-10 col-md-offset-2">
							...
							<div class="form-group">
							  ...
							  <label class="col-md-1 control-label" for="emp_age">ID No</label>
							  <div class="col-md-2">
							  <input id="emp_age" name="emp_age" type="number" value = "<?php echo $age;?>" placeholder="ID NO" class="form-control input-md" required="">
						...
						<div class = "col-md-10 col-md-offset-2">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3">
							  <input id="sss" name="sss" type="text" value = "<?php echo $sss;?>" placeholder="Cover Number" class="form-control input-md" required="">
								
							  </div>
							  <label class="col-md-2 control-label" for="pagibig">NSSF Number</label>
							  <div class="col-md-3">
							  <input id="pagibig" name="pagibig" type="text" value = "<?php echo $pagibig;?>" placeholder="NSSF Number" class="form-control input-md" required="">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3">
							  <input id="philhealth" name="philhealth" type="text" value = "<?php echo $philhealth;?>" placeholder="NHIF Health Number" class="form-control input-md" required="">
								
							  </div>
							  <label class="col-md-2 control-label" for="TIN">Morgage Number</label>
							  <div class="col-md-3">
							  <input id="tin" name="tin" type="text" value = "<?php echo $tin;?>" placeholder="Morgage Number" class="form-control input-md" required="">
