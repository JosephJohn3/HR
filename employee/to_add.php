					...
					<div class="panel-heading">ITINERARY OF TRAVEL</div>
						<div class="panel-body">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3">
							  <input id="to_trans" name="to_trans" onChange="updatesum()" type="number" min="10" placeholder="Transportation" class="form-control input-md">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3">
							  <input id="to_regis" name="to_regis" type="number" min="10" onChange="updatesum()" placeholder="Registration" class="form-control input-md">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3">
							  <input id="to_bal" name="to_bal" type="number" min="10" onChange="updatesum()" placeholder="Board and Lodging" class="form-control input-md">
