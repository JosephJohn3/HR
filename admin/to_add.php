				...
				<script type="text/javascript">
					...
					<form name="form" enctype="multipart/form-data" method="post" class="form-horizontal">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">                     
								<textarea class="form-control" id="to_venue" name="to_venue" placeholder = "Venue" required></textarea>
							  </div>
							</div>
					...
					<div class="panel-heading">ITINERARY OF TRAVEL</div>
						<div class="panel-body">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3">
							  <input id="to_etd" name="to_etd" type="date" placeholder="Estimated Time Departure" class="form-control input-md" required>
							  </div>
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3">
							  <input id="to_bal" name="to_bal" type="text" onChange="updatesum()" placeholder="Board and Lodging" class="form-control input-md" required>
