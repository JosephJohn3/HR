			...
			<div class="panel-body">
					<form enctype="multipart/form-data" method="post" class="form-horizontal">
						<fieldset>
							...
							<!-- Text input-->
							<div class="form-group">
							  <label class="col-md-2 control-label" for="emp_age">ID NO</label>
							  <div class="col-md-2">
							  <input id="emp_age" name="emp_age" type="number" min="10000" placeholder="ID number" class="form-control input-md" required="">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">                     
								<textarea class="form-control" id="emp_add" name="emp_add" required placeholder="Address"></textarea>
							  </div>
							</div>
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							  <input id="emp_cont" name="emp_cont" type="number" placeholder="Contact Number" class="form-control input-md" required="">
							...
							<div class="form-group">
							  <label class="col-md-2 control-label" for="sss">Cover Number</label>
							  <div class="col-md-3">
							  <input id="sss" name="sss" type="text" placeholder="Cover Number" class="form-control input-md" required="">
								
							  </div>
							  <label class="col-md-2 control-label" for="pagibig">NSSF Number</label>
							  <div class="col-md-3">
							  <input id="pagibig" name="pagibig" type="text" placeholder="NSSF Number" class="form-control input-md" required="">
								
							  </div>
							</div>

							<div class="form-group">
							  <label class="col-md-2 control-label" for="philhealth">NHIF Health Number</label>
							  <div class="col-md-3">
							  <input id="philhealth" name="philhealth" type="text" placeholder="NHIF Health Number" class="form-control input-md" required="">
								
							  </div>
							  <label class="col-md-2 control-label" for="TIN">Morgage Number</label>
							  <div class="col-md-3">
							  <input id="tin" name="tin" type="text" placeholder="Morgage Number" class="form-control input-md" required="">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-2">
								<select id="emp_stat" name="emp_stat" class="form-control" required>
							  ...
							  <div class="col-md-2">
								<select id="emp_pos" name="emp_pos" class="form-control" required>
